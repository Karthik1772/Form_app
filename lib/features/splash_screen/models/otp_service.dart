  ...
  Future<Map<String, dynamic>> sendOtp(String email) async {
    try {
      ...
      final smtpServer = SmtpServer(
        ...
        port: 587,
        username: 'formifyacess@gmail.com',  // Replace with your actual Gmail address
        password: 'lpvnxnhbyteaxvjc',     // Replace with your 16-character App Password
        ssl: false,
        allowInsecure: false,
      );
      
      final message = Message()
        ..from = Address('formifyacess@gmail.com', 'Formify App')  // Replace with your actual Gmail address
      ...
      try {
        ...
        return {'success': false, 'message': 'Failed to send OTP email: ${e.toString()}'};
      }
    } catch (e) {
